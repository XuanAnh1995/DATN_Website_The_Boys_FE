        ...
        <div className="space-y-3 mb-4">
            ...
            <div className="grid grid-cols-4 gap-3">
                <div>
                    ...
                    <Select
                        name="collarId"
                        options={collars.map(collar => ({ value: collar.id, label: collar.collarName }))}
                        isMulti
                        onChange={selectedOptions => handleFilterChange("collarIds", selectedOptions)}
                        className="text-xs"
                ...
                <div>
                    ...
                    <Select
                        ...
                        isMulti
                        onChange={selectedOptions => handleFilterChange("sleeveIds", selectedOptions)}
                        className="text-xs"
                ...
                <div>
                    ...
                    <Select
                        name="colorId"
                        options={colors.map(color => ({ value: color.id, label: color.colorName }))}
                        isMulti
                        onChange={selectedOptions => handleFilterChange("colorIds", selectedOptions)}
                        className="text-xs"
                ...
                <div>
                    ...
                    <Select
                        name="sizeId"
                        options={sizes.map(size => ({ value: size.id, label: size.sizeName }))}
                        isMulti
                        onChange={selectedOptions => handleFilterChange("sizeIds", selectedOptions)}
                        className="text-xs"
