        ...
        <>
            <div className="modal modal-open">
                <div className="modal-box relative max-w-5xl w-full">
                    ...
                    <h3 className="font-bold text-lg text-blue-600 text-center">Cập nhật khách hàng</h3>
                    <div className="flex">
                        ...
                        <div className="w-1/2 pl-4">
                            ...
                            <button className="btn bg-blue-500 hover:bg-blue-600 text-white w-full mt-2" onClick={handleAddAddress}>Thêm địa chỉ mới</button>
