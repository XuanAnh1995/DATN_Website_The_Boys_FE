...
export default function Size() {
  ...
  const fetchSizes = useCallback(async () => {
    try {
      ...
      toast.error("Đã xảy ra lỗi khi tải dữ liệu Size");
    }
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <h1 className="text-xl font-bold mb-4">Quản lý Size</h1>
          ...
          {sizes.map((item, index) => (
            <tr key={item.id} className="bg-white hover:bg-gray-100">
              ...
              <td className="px-4 py-2 flex justify-center gap-4">
                <button className="text-blue-500" onClick={() => handleUpdateSize(item)}>
