...
export default function Sleeve() {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <h1 className="text-xl font-bold mb-4">Quản lý Sleeve</h1>
      <div className="flex items-center justify-between mb-4">
        <input
          type="text"
          placeholder="Tìm kiếm Sleeve"
      ...
      <table className="table-auto w-full bg-white rounded-lg shadow text-center text-xs">
        <thead>
          <tr className="bg-gray-100">
            ...
            <th className="px-4 py-2 cursor-pointer" onClick={() => handleSort("sleeveName")}>Tên Sleeve</th>
          ...
          {sleeves.map((item, index) => (
            <tr key={item.id} className="bg-white hover:bg-gray-100">
              ...
              <td className="px-4 py-2 flex justify-center gap-4">
                <button className="text-blue-500" onClick={() => handleUpdateSleeve(item)}>
