...
const SleeveService = {
    ...
    getAllSleeves: async (search = "", page = 0, size = 10, sortBy = "id", sortDir = "asc") => {
        try {
            ...
            console.error("❌ Lỗi khi lấy danh sách tay áo:", error.response?.data || error.message);
    ...
    getSleeveById: async (id) => {
        try {
            ...
            console.error(`❌ Lỗi khi lấy tay áo ${id}:`, error.response?.data || error.message);
            throw error;
        }
    },
    ...
    createSleeve: async (sleeveCreateRequest) => {
        try {
            ...
            console.error("❌ Lỗi khi tạo tay áo:", error.response?.data || error.message);
            throw error;
        }
    },
    ...
    updateSleeve: async (id, sleeveUpdateRequest) => {
        try {
            ...
            console.error(`❌ Lỗi khi cập nhật tay áo ${id}:`, error.response?.data || error.message);
            throw error;
        }
    },
    ...
    deleteSleeve: async (id) => {
        try {
            ...
            console.error(`❌ Lỗi khi xóa tay áo ${id}:`, error.response?.data || error.message);
            throw error;
        }
    },
    ...
    toggleStatusSleeve: async (id) => {
        try {
            ...
            console.error(`❌ Lỗi khi thay đổi trạng thái tay áo ${id}:`, error.response?.data || error.message);
            throw error;
        }
    },
};
