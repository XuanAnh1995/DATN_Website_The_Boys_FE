...
const MaterialService = {
    ...
    getAllMaterials: async (search = "", page = 0, size = 10, sortBy = "id", sortDir = "asc") => {
        try {
            ...
            console.error("❌ Lỗi khi lấy danh sách chất liệu:", error.response?.data || error.message);
    ...
    getMaterialById: async (id) => {
        try {
            ...
            console.error(`❌ Lỗi khi lấy chất liệu ${id}:`, error.response?.data || error.message);
            throw error;
        }
    },
    ...
    createMaterial: async (materialData) => {
        try {
            ...
            console.error("❌ Lỗi khi tạo chất liệu:", error.response?.data || error.message);
            throw error;
        }
    },
    ...
    updateMaterial: async (id, materialData) => {
        try {
            ...
            console.error(`❌ Lỗi khi cập nhật chất liệu ${id}:`, error.response?.data || error.message);
            throw error;
        }
    },
    ...
    toggleStatusMaterial: async (id) => {
        try {
            ...
            console.error(`❌ Lỗi khi thay đổi trạng thái chất liệu ${id}:`, error.response?.data || error.message);
            throw error;
        }
    },
};
