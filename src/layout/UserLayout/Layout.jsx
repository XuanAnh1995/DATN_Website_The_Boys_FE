  ...
  useEffect(() => {
    const fetchNewProductDetails = async () => {
      try {
        ...
        const response = await ProductDetailService.getAllProductDetails(params);
            ...
            productDetails.map((productDetail) => (
              ...
              >
                <div className="relative">
                  <img
                    src={productDetail.photo || "/path/to/default-image.jpg"}
                ...
                <p className="text-center text-gray-600">
                  Mã sản phẩm: {productDetail.productDetailCode}
                </p>
                <p className="text-center text-red-600 font-bold text-lg mt-1">
                  {productDetail.salePrice} VND
                </p>
                ...
                <div className="absolute bottom-4 left-0 right-0 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button
                    onClick={() => navigate(`/view-product/${productDetail.id}`)}
          ...
          <div className="md:col-span-2 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {newProductDetails.map((productDetail) => (
              ...
              >
                ...
                <p className="text-red-600">{productDetail.salePrice} VND</p>
                ...
                <div className="absolute bottom-2 left-0 right-0 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button
                    onClick={() => navigate(`/san-pham/${productDetail.id}`)}
